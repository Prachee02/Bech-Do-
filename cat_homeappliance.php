                    ...
                    <div class="category-list">
                        ...
                        <div class="tab-box">
                            <ul class="nav nav-tabs add-tabs tablist" id="myTab" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link active" id="home-tab" data-bs-toggle="tab" data-bs-target="#home" type="button" role="tab" aria-controls="home" aria-selected="true">Home Appliances <span class="badge badge-pill bg-secondary"></span></a>
                                </li>
                        ...
                        <div class="listing-filter">
                            <div class="pull-left col-xs-6">
                                <div class="breadcrumb-list"><a href="#" class="current"> <span>All Home Appliances</span></a> 
                        ...
                        <!--/.listing-filter-->
						<?php
					     $sql = "SELECT * FROM ad_detail WHERE category_group='Homeappliance'";
					      include 'util.php';
					      $conn = dbConnect();
