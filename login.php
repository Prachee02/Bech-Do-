...
<!-- Mirrored from templatecycle.com/demo/bootclassified-6/dist/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 18 Oct 2022 16:13:13 GMT -->
<head>
    <meta charset="utf-8">
                    ...
                    <div class="navbar-collapse collapse" id="navbarsDefault">
                        ...
                        <!-- <ul class="nav navbar-nav ml-auto navbar-right">
                            ...
                            <li class="dropdown no-arrow nav-item"><a href="#" class="nav-link dropdown-toggle" href="#"
                                ...
                                <span></span> <i class="icon-user fa"></i> <i class=" icon-down-open-big fa"></i></a>
                                <ul
    ...
    <div class="main-container">
        <div class="container">
            <div class="row">
                        ...
                        <div class="panel-intro text-center">
                            <h2 class="logo-title">
                                ...
                                <span class="logo-icon"><i
                                        class="icon icon-search-1 ln-shadow-logo shape-0"></i> </span> Log<span>In </span>
                            </h2>
                        </div>
						<?php
                ...
                ?>
                        <div class="card-body">
                            <form role="form" action="usercheck.php" method="POST">
                                <div class="form-group">
                                    <label for="sender-email" class="control-label">Email:</label>

                                    <div class="input-icon"><i class="icon-user fa"></i>
                                        <input id="sender-email" type="text" placeholder="Email"
                                               class="form-control email" name="fname">
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <input type="submit" href="index-v-2.php" class="btn btn-primary  btn-block">
                                </div>
                        ...
                        <div class="card-footer">
                            ...
                            <p class="text-center pull-right"><a href="forgot-password.html"> Forget password? </a>
                            </p>
