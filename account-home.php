...
<!-- Mirrored from templatecycle.com/demo/bootclassified-6/dist/account-home.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 18 Oct 2022 16:07:59 GMT -->
<head>
    <meta charset="utf-8">
        ...
        <nav class="navbar  fixed-top navbar-site navbar-light bg-light navbar-expand-md"
            ...
            <div class="container">
                ...
                <div class="navbar-identity">
                    <a href="index-v-2.php" class="navbar-brand logo logo-title">
                        ...
                        <div class="inner-box">
                            <div class="user-panel-sidebar">
                                <div class="collapse-box">
                                    <h5 class="collapse-title no-border"> My Account <a href="#MyClassified"  aria-expanded="true"  data-bs-toggle="collapse"
                                                                                           class="pull-right"><i
                                            class="fa fa-angle-down"></i></a></h5>

                                    <div class="panel-collapse collapse show" id="MyClassified">
                                        <ul class="acc-list">
                                            <li><a class="active" href="account-home.php"><i class="icon-home"></i>
                                                Personal Home </a></li>
                                ...
                                <!-- /.collapse-box  -->
                                <div class="collapse-box">
                                    <h5 class="collapse-title"> My Ads <a href="#MyAds" aria-expanded="true"  data-bs-toggle="collapse"
                                                                          class="pull-right"><i
                                            class="fa fa-angle-down"></i></a></h5>

                                    <div class="panel-collapse collapse show" id="MyAds">
                                        <ul class="acc-list">
                                            <li><a href="account-myads.php"><i class="icon-docs"></i> My ads <span
                                                    class="badge"></span> </a></li>
                                            <li><a href="account-favourite-ads.php"><i class="icon-heart"></i>
                                                Favourite ads <span class="badge bg-secondary"></span> </a></li>
                                            <!-- <li><a href="account-saved-search.php"><i class="icon-star-circled"></i>
                                                Saved search <span class="badge bg-secondary"></span> </a></li> -->
                                            <li class=""><a href="account-message-inbox.php"><i
                                ...
                                <div class="collapse-box">
                                    ...
                                    <div class="panel-collapse collapse show" id="TerminateAccount">
                                        <ul class="acc-list">
                                            <li><a href="account-close.php"><i class="icon-cancel-circled "></i> Close
                                                account </a></li>
                                        </ul>
                                    </div>
                                </div>
                ...
                <div class="col-md-9 page-content">
                    ...
                    <div class="inner-box">
                        <div class="welcome-msg">
                            <h3 class="page-sub-header2 clearfix no-padding">Hello <?=$fname?> !</h3>
                            <!-- <span class="page-sub-header-sub small">You last logged in at: 01-01-2014 12:40 AM [UK time (GMT + 6:00hrs)]</span> -->
                        </div>
                        <div id="accordion" class="panel-group">
                            <div class="card card-default">
                                <div class="card-header">
                                    <h4 class="card-title"><a href="#collapseB1" aria-expanded="true"  data-bs-toggle="collapse" > My
                                        details </a></h4>
                                </div>
                            ...
                            <div class="card card-default">
                                <div class="card-header">
                                    <h4 class="card-title"><a href="#collapseB2" aria-expanded="true"  data-bs-toggle="collapse" > Settings </a>
                                    </h4>
                                </div>
...
<!-- Mirrored from templatecycle.com/demo/bootclassified-6/dist/account-home.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 18 Oct 2022 16:08:00 GMT -->
</html>
